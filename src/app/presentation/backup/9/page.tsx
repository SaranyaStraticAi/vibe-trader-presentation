...
export default function Slide9() {
  ...
  const stats = [
    ...
    { icon: Globe2, value: '7', label: 'Regions' }
  ];
              ...
              >
                ...
                <div className="p-4 bg-green-50 border-2 border-green-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-black mb-1">Pilots Ready to Launch</p>
                      <p className="text-xs text-gray-600 mb-1">
                        <strong>D Prime:</strong> London • 2M traders • Largest forex broker opportunity
                      </p>
                      <p className="text-xs text-gray-600">
                        <strong>Blueberry:</strong> Australia/Vanuatu • 50K traders • Director confirmed
                      </p>
                    </div>
                  </div>
                </div>
